      ...
      <div className="row my-5">
        ...
        <div className="col-12 col-md-8">
          <p className="col-12">
            ...
            My previous work experiences have been very human-centric. These took place in multiple, divergent environments, where I was able to pick up a variety of practical intrapersonal, technical, and communicative skills.
          ...
          <p className="col-12">
            ...
            I began to search backwards for an alternative career where I could always continue to learn and grow, and recalled a Java class that I took and enjoyed during university.
