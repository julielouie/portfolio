...
function Project(props) {
  ...
  const liveCode = props.current !== 0 ? <a className={`proj-link ${textColor} my-5 mr-3 ${borderColor} rounded p-2`} href={props.projects[props.current].gitLink}>
  ...
  return (
    <>
      ...
      {liveCode}
      <a className={`proj-link ${textColor} my-5 ${borderColor} rounded p-2`} href={props.projects[props.current].link}>
